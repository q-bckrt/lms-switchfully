...
public class UserMapperTest {
    ...
    void givenValidUserInputDto_whenInputToUser_thenReturnUser() {
        ...
        // Expected
        User expectedUser = new User("test", "testFirstname testLastName","testFirstname","testLastName", "test@test.com", UserRole.STUDENT);
        //when
    ...
    void givenUserEntity_whenUsertoOutputDto_thenReturnUserOutputDto() {
        //Given
        User user = new User("test", "testDisplay","testFirstname","testLastName", "test@test.com", UserRole.STUDENT);
        // expected
